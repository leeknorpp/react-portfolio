...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://leeknorpp.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post",
    };
  ...
  UNSAFE_componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://leeknorpp.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "patch",
      });
    }
  }
  ...
  handleRichTextEditorChange(content) {
    this.setState({
      content, //Sets the state all at once because the key and the variable are the same
    });
  }
  ...
  buildForm() {
    ...
    formData.append("portfolio_blog[title]", this.state.title); // text in quotes specific to api
  ...
  handleChange(event) {
    this.setState({
      [event.target.name]: event.target.value, //If you're passing in a variable as a key, use the []s
    });
  }
